...
classdef Link < matlab.mixin.Copyable
    ...
    methods
        ...
        function T = A(L, q, convertToSE3)
            ...
            % UTS added the ability to stop the SE3 conversion, since the
            % SE3 conversion is so slow (~40x slower than the total of the
            % rest of the function combined)  
            if nargin < 3
                convertToSE3 = true;
            end
            ...
            % UTS added since SE3 conversion is so slow (~40x slower than the total of the rest of the function)
            if convertToSE3
                T = SE3(T);
            end
