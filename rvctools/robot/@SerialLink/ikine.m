...
%                   Levenberg-Marquadt
% 'forceSoln'       ikine will return the closest (most recent) calculated
%                   solution if the solution diverges rather than returning
%                   a blank vector of joint states (UTS addition)
%
...
%   limits defined.
% - Edited for UTS Industrial Robotics to give the option of always returning
%   an output if the solution is diverging - similar to that of V9 ikine by 
%   setting the 'forceSoln' option as an argument in the function call (Feb
%   2023).
%
